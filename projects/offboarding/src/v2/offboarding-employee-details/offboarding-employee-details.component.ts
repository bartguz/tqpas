...
import { OffboardingFormModalComponentV2 } from '../offboarding-form-modal/offboarding-form-modal.component';
import { EmployeeDetailsService } from './service/employee-details.service';

@Component({
  selector: 'lib-offboarding-employee-details-v2',
  imports: [AsyncPipe, SkeletonComponent, OffboardingFormModalComponentV2],
...
export class OffboardingEmployeeDetailsComponentV2 {
